 ...
 for (var districtId in json) {
                    ...
                    for (var i = 1; i < json[districtId].length; i++) {
                        ...
                        if(json[districtId][i].isMerge == 1){
                        	...
                        	if(json[districtId][i].context != "" && i == 1){
                              	code +=  '<td  style="display:inline;font-weight:bold;font-size:' +json[districtId][i].fontSize+'pt;font-family:'+json[districtId][i].fontName+'"  align='+json[districtId][i].alignmentEnum + '>'   +json[districtId][i].context+' :&nbsp;&nbsp;&nbsp;</td>';
                        	}else{
                              	code +=  '<td  style="display:inline;font-weight:bold;font-size:' +json[districtId][i].fontSize+'pt;font-family:'+json[districtId][i].fontName+'"  align='+json[districtId][i].alignmentEnum + '>'   +json[districtId][i].context+'&nbsp;&nbsp;&nbsp;&nbsp;</td>';
                        	}
                        }
...
for (var i = 1; i < 2; i++) {
                        //console.log("i=" + i +" data = " + data[districtId][i])
                        if(json[districtId][1].isMerge == 1){
                          	code +=  '<td rowspan='+(json[districtId][1].lastColumn-json[districtId][1].firstColumn ) + ' colspan =' +(json[districtId][1].lastRow-json[districtId][1].firstRow + 2)+  ' style="font-weight:bold;font-size:'+json[districtId][1].fontSize+'pt;font-family:'+json[districtId][1].fontName+'"  align="center" >'+json[districtId][1].context+'</td>';
                        }else{
                        	if(json[districtId][1].context != "" && json[districtId][2].context != ""){
                              	code +=  '<td  style="display:inline;font-weight:bold;font-size:' +json[districtId][1].fontSize+'pt;font-family:'+json[districtId][1].fontName+'"  align='+json[districtId][1].alignmentEnum + '>'   +json[districtId][1].context+' :&nbsp;&nbsp;&nbsp;</td>';
                              	code +=  '<td  style="display:inline;font-weight:bold;font-size:' +json[districtId][2].fontSize+'pt;font-family:'+json[districtId][2].fontName+'"  align='+json[districtId][2].alignmentEnum + '>'   +json[districtId][2].context+' &nbsp;&nbsp;&nbsp;</td>';
...
Map  syncArg = Fx.json.parse("{\"objectData\":{\"objAPIName\":\"object_fhxq\",\"masterFieldVal\":{\"name\":\"FH22042418\",\"owner\":\"1\",\"field_6aXp7__c\":\"测试呃呃二\",\"object_describe_api_name\":\"object_fhxq\",\"tenant_id\":\"724968\",\"_id\":\"6264b4b1d28a1100013812b7\"},\"detailFieldVals\":{\"object_fhxqmx\":[{\"name\":\"242635\",\"mid\":\"6264b4b1d28a1100013812b7\",\"field_6P5mj__c\":\"123435677\",\"field_z4qql__c\":\"000010\",\"field_Dq97B__c\":\"WMC-6902T_904200150000A_RD0002\",\"field_vb4Zq__c\":\"10.000\",\"field_Wloz5__c\":\"2022-05-13\",\"field_1bgjT__c\":\"0\",\"object_describe_api_name\":\"object_fhxqmx\",\"tenant_id\":\"724968\",\"_id\":\"6264b4c3d28a1100013818ff\",\"owner\":[\"1001\"],\"created_by\":[]}]}}}")
//获取提交数据syncArg
...
//发起加急发货流程1
if(cus_name.contains("测试qwqwqqq") && qqTime != null){
  if(list.size()>0){
